...
.. code-block:: console
    ...
    micropython -m mip install https://emlearn.github.io/emlearn-micropython/builds/master/xtensawin_6.3/emlearn_trees.mpy

For ARM Cortex M4F/M33/M7 etc use the ``armv7emsp`` architecture.

.. code-block:: console

    micropython -m mip install https://emlearn.github.io/emlearn-micropython/builds/master/armv7emsp_6.3/emlearn_trees.mpy
